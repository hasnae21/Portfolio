...
const DEFAULT_PROJECTS = [
  { id: 'trash-detector-robot', title: 'Trash Detector Robot', subtitle: 'YOLOv8 Real-time Waste Detection', description: 'Intelligent trash detection system trained on the TACO dataset, reduced and categorized into 5 waste classes. Supports real-time webcam detection for autonomous robot integration.', category: 'computer-vision', tags: ['Python', 'YOLOv8', 'OpenCV', 'Ultralytics', 'TACO Dataset'], github: 'https://github.com/hasnae21/Trash-detector-Robot', demo: null, image: null, icon: '🤖', featured: true, date: '2024', status: 'completed' },
  { id: 'ros2-cafe-robot', title: 'ROS2 Café Service Robot', subtitle: 'Autonomous Indoor Delivery Robot', description: 'Full ROS2 Humble stack for an autonomous mobile robot designed for café/restaurant environments. Features Nav2 autonomous navigation, SLAM Toolbox for mapping, and Gazebo simulation.', category: 'robotics', tags: ['ROS2', 'Nav2', 'SLAM', 'Python', 'Gazebo', 'URDF'], github: 'https://github.com/hasnae21/ros2-cafe-service-robot', demo: null, image: null, icon: '☕', featured: true, date: '2025', status: 'in-progress' },
  { id: 'serbai-mobile-app', title: 'SerbAI Mobile App', subtitle: 'Android Interface for Delivery Robot', description: 'Android command & supervision interface for an autonomous line-following restaurant delivery robot. Features Auto/Manual/Stop modes, Bluetooth SPP control, 3 speed levels, and real-time event logging.', category: 'mobile', tags: ['Android', 'Java', 'Kotlin', 'Bluetooth SPP', 'HC-05'], github: 'https://github.com/hasnae21/SerbAI_mobile_application', demo: null, image: null, icon: '📱', featured: true, date: '2025', status: 'completed' },
  { id: 'skinaid-web-app', title: 'SkinAid Web App', subtitle: 'AI-Based Skin Disease Detection', description: 'Web application using deep learning and image processing to detect and classify skin diseases from user-uploaded photos. Trained on Google Colab with Python and Jupyter.', category: 'ai-ml', tags: ['Python', 'Deep Learning', 'OpenCV', 'Jupyter', 'Google Colab'], github: null, demo: null, image: null, icon: '🩺', featured: false, date: '2024', status: 'completed' },
  { id: 'hack-ai-morocco', title: 'Hack AI Morocco', subtitle: 'Event Platform — 4-Day AI Hackathon', description: 'Dynamic web platform for "Hack AI Morocco", a 4-day hackathon bringing AI students across Morocco together for intensive challenges. Built with Astro, Tailwind CSS, and TypeScript.', category: 'web', tags: ['Astro', 'TypeScript', 'Tailwind CSS', 'JavaScript', 'GitHub Actions'], github: 'https://github.com/hasnae21/Potfolio_Hackathon', demo: null, image: null, icon: '🏆', featured: false, date: '2024', status: 'completed' },
  { id: 'projet7-laravel-react', title: 'Laravel + React App', subtitle: 'Full-Stack API Integration', description: 'Full-stack application connecting a Laravel REST API backend with a React.js frontend. Implements CRUD operations, Blade templates, and demonstrates modern API consumption patterns.', category: 'web', tags: ['Laravel', 'React.js', 'PHP', 'MySQL', 'REST API'], github: 'https://github.com/hasnae21/Projet_7', demo: null, image: null, icon: '🌐', featured: false, date: '2023', status: 'completed' },
  { id: 'free-fall-detection', title: 'Free-Fall Detection System', subtitle: 'Model-Based Design in Simulink', description: 'Real-time free-fall detection logic in MATLAB/Simulink following Model-Based Design methodology (MIL/SIL testing) with accelerometer signal processing and threshold logic.', category: 'embedded', tags: ['MATLAB', 'Simulink', 'Model-Based Design', 'MIL/SIL'], github: null, demo: null, image: null, icon: '📡', featured: false, date: '2024', status: 'completed' },
  { id: 'fir-filter-fpga', title: 'FIR Filter on FPGA', subtitle: 'VHDL Implementation on Cyclone V', description: 'Digital FIR filter implemented in VHDL for Altera Cyclone V FPGA. Designed, synthesized, and verified with Quartus Prime and ModelSim simulation environments.', category: 'embedded', tags: ['VHDL', 'FPGA', 'Cyclone V', 'Quartus', 'ModelSim'], github: null, demo: null, image: null, icon: '⚡', featured: false, date: '2024', status: 'completed' },
  { id: 'secure-locking-system', title: 'Secure Locking System', subtitle: 'PIC16F877A + RFID Embedded Design', description: 'Smart security locking system using PIC16F877A with RFID authentication, keypad input, and LCD display. Programmed in MicroC and fully simulated in Proteus 8.', category: 'embedded', tags: ['PIC16F877A', 'RFID', 'MicroC', 'Proteus 8', 'LCD'], github: null, demo: null, image: null, icon: '🔐', featured: false, date: '2023', status: 'completed' }
];

const CATEGORY_LABELS = {
  'computer-vision': 'Computer Vision', 'ai-ml': 'AI & ML', 'embedded': 'Embedded',
  'web': 'Web Dev', 'mobile': 'Mobile', 'robotics': 'Robotics', 'other': 'Other'
};
...
const ROLES = ['Robotics & Cobotics Engineer', 'AI & Computer Vision Developer', 'Full-Stack Web Developer', 'Android App Developer', 'ROS2 & Embedded Engineer'];
